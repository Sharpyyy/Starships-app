package com.example.swapi_starships_mod_b8_share_detail.di

import com.example.swapi_starships_mod_b8_share_detail.data.remote.SwapiApi
import com.example.swapi_starships_mod_b8_share_detail.data.repository.StarshipRepositoryImpl
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideStarshipRepository(impl: StarshipRepositoryImpl): StarshipRepository = impl
}
